...
CELEBRITY_PROFILES = {
    ...
    # 5. NVIDIA 核心团队
    "nvidia": {"name": "NVIDIA 官方团队", "handle": "@NVIDIA", "role": "NVIDIA 官方技术与算力前沿", "avatar": "https://unavatar.io/nvidia", "platform": "x", "entity_type": "company"},
    "jim fan": {"name": "Jim Fan", "handle": "@DrJimFan", "role": "NVIDIA AI Agent 负责人", "avatar": "https://unavatar.io/x/DrJimFan", "platform": "x", "entity_type": "person"},
    "drjimfan": {"name": "Jim Fan", "handle": "@DrJimFan", "role": "NVIDIA AI Agent 负责人", "avatar": "https://unavatar.io/x/DrJimFan", "platform": "x", "entity_type": "person"},
    ...
    "openai": {"name": "OpenAI 官方", "handle": "@OpenAI", "role": "OpenAI 官方发布平台", "avatar": "https://unavatar.io/openai", "platform": "x", "entity_type": "company"},
    ...
    "anthropicai": {"name": "Anthropic 官方团队", "handle": "@AnthropicAI", "role": "Claude 研发官方团队", "avatar": "https://unavatar.io/anthropic", "platform": "x", "entity_type": "company"},
    ...
    # 6. xAI / 独立前沿机构
    "elon musk": {"name": "Elon Musk", "handle": "@elonmusk", "role": "xAI / Tesla", "avatar": "https://unavatar.io/x/elonmusk", "platform": "x", "entity_type": "person"},
    "musk": {"name": "Elon Musk", "handle": "@elonmusk", "role": "xAI / Tesla", "avatar": "https://unavatar.io/x/elonmusk", "platform": "x", "entity_type": "person"},
    "ilya sutskever": {"name": "Ilya Sutskever", "handle": "@ilyasut", "role": "SSI 联合创始人 / 深度学习泰斗", "avatar": "https://unavatar.io/x/ilyasut", "platform": "x", "entity_type": "person"},
    "sutskever": {"name": "Ilya Sutskever", "handle": "@ilyasut", "role": "SSI 联合创始人 / 深度学习泰斗", "avatar": "https://unavatar.io/x/ilyasut", "platform": "x", "entity_type": "person"},
    "andrej karpathy": {"name": "Andrej Karpathy", "handle": "@karpathy", "role": "AI 领军学者 / Eureka Labs", "avatar": "https://unavatar.io/x/karpathy", "platform": "x", "entity_type": "person"},
    "karpathy": {"name": "Andrej Karpathy", "handle": "@karpathy", "role": "AI 领军学者 / Eureka Labs", "avatar": "https://unavatar.io/x/karpathy", "platform": "x", "entity_type": "person"},
    "francois chollet": {"name": "François Chollet", "handle": "@fchollet", "role": "ARC-AGI 创始人 / Keras 作者", "avatar": "https://unavatar.io/x/fchollet", "platform": "x", "entity_type": "person"},
    "chollet": {"name": "François Chollet", "handle": "@fchollet", "role": "ARC-AGI 创始人 / Keras 作者", "avatar": "https://unavatar.io/x/fchollet", "platform": "x", "entity_type": "person"},
    ...
    "simon willison": {"name": "Simon Willison", "handle": "@simonw", "role": "独立 AI 工程师 / Prompt Injection 提出者", "avatar": "https://unavatar.io/x/simonw", "platform": "x", "entity_type": "person"},
    "harrison chase": {"name": "Harrison Chase", "handle": "@hwchase17", "role": "LangChain 创始人兼 CEO", "avatar": "https://unavatar.io/x/hwchase17", "platform": "x", "entity_type": "person"},
    "swyx": {"name": "Swyx (Shawn Wang)", "handle": "@swyx", "role": "AI Engineer Foundation / Latent Space", "avatar": "https://unavatar.io/x/swyx", "platform": "x", "entity_type": "person"},
    "george hotz": {"name": "George Hotz (geohot)", "handle": "@realgeohot", "role": "tinygrad 创始人 / 极客黑客", "avatar": "https://unavatar.io/x/realgeohot", "platform": "x", "entity_type": "person"},
    "geohot": {"name": "George Hotz (geohot)", "handle": "@realgeohot", "role": "tinygrad 创始人 / 极客黑客", "avatar": "https://unavatar.io/x/realgeohot", "platform": "x", "entity_type": "person"},
    "bindu reddy": {"name": "Bindu Reddy", "handle": "@bindureddy", "role": "Abacus.ai CEO", "avatar": "https://unavatar.io/x/bindureddy", "platform": "x", "entity_type": "person"},
    "pieter abbeel": {"name": "Pieter Abbeel", "handle": "@pabbeel", "role": "UC 伯克利机器人实验室教授", "avatar": "https://unavatar.io/x/pabbeel", "platform": "x", "entity_type": "person"},
    "deepseek": {"name": "DeepSeek 核心研发团队", "handle": "@deepseek_ai", "role": "DeepSeek 官方研发团队", "avatar": "https://unavatar.io/github/deepseek-ai", "platform": "x", "entity_type": "company"},
    
    # 8. 业界顶尖 AI 公司掌门人、前沿研究员与独立极客观察家 (含大家高度关注的 Tibo)
    "tibo": {"name": "Tibo", "handle": "@tibo_maker", "role": "独立 AI 创作者 / 极客架构观察家", "avatar": "https://unavatar.io/x/tibo_maker", "platform": "x", "entity_type": "person"},
    ...
    "nadella": {"name": "Satya Nadella", "handle": "@satyanadella", "role": "微软董事长兼 CEO", "avatar": "https://unavatar.io/x/satyanadella", "platform": "x", "entity_type": "person"},
    "jason wei": {"name": "Jason Wei", "handle": "@_jasonwei", "role": "OpenAI 研究员 / 思维链 CoT 奠基人", "avatar": "https://unavatar.io/x/_jasonwei", "platform": "x", "entity_type": "person"},
    "_jasonwei": {"name": "Jason Wei", "handle": "@_jasonwei", "role": "OpenAI 研究员 / 思维链 CoT 奠基人", "avatar": "https://unavatar.io/x/_jasonwei", "platform": "x", "entity_type": "person"},
    "rowan cheung": {"name": "Rowan Cheung", "handle": "@rowancheung", "role": "The Rundown AI 创始人", "avatar": "https://unavatar.io/x/rowancheung", "platform": "x", "entity_type": "person"},
    ...
    "amjad masad": {"name": "Amjad Masad", "handle": "@amasad", "role": "Replit CEO / AI Agent 原生环境开创者", "avatar": "https://unavatar.io/x/amasad", "platform": "x", "entity_type": "person"},
    "nat friedman": {"name": "Nat Friedman", "handle": "@natfriedman", "role": "AI 领军投资人 / 前 GitHub CEO", "avatar": "https://unavatar.io/x/natfriedman", "platform": "x", "entity_type": "person"},
