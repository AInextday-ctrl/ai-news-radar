window.WECHAT_ARTICLES_DATA = {
  "updated_at": "2026-09-17T11:17:16.557518+00:00",
  "date": "2026-09-17",
  "total_articles": 1,
  "audit_funnel": {
    "total_candidates": 625,
    "previously_published_excluded": 3,
    "fresh_candidates_scanned": 622,
    "disqualified_count": 621,
    "qualified_count": 1,
    "published_count": 1,
    "pass_rate_percent": 0.2,
    "disqualified_breakdown": {
      "previously_published": 3,
      "no_authentic_media": 365,
      "outdated_baselines": 0,
      "below_score_threshold": 256
    },
    "disqualification_reasons_desc": [
      "历史已发条目排除 (防止重复炒冷饭): 3 篇 (打标永久封存，0 Token 跳过)",
      "缺少一手真实图文/视频凭证: 365 篇 (按硬门禁扣40分一票否决)",
      "引用过时淘汰陈旧基准: 0 篇 (扣20分)",
      "观点平庸/缺乏硬核架构与落地账本 (<95分): 256 篇"
    ],
