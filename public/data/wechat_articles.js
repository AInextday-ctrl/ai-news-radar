window.WECHAT_ARTICLES_DATA = {
  "updated_at": "2026-09-23T05:14:39.223438+00:00",
  "date": "2026-09-23",
  "total_articles": 1,
  "audit_funnel": {
    "total_candidates": 1481,
    "previously_published_excluded": 11,
    "fresh_candidates_scanned": 1470,
    "disqualified_count": 1470,
    "qualified_count": 3,
    "published_count": 3,
    "pass_rate_percent": 0.2,
    "disqualified_breakdown": {
      "previously_published": 11,
      "no_authentic_media": 769,
      "outdated_baselines": 0,
      "below_score_threshold": 701
    },
    "disqualification_reasons_desc": [
      "历史已发条目排除 (防止重复炒冷饭): 11 篇 (打标永久封存，0 Token 跳过)",
      "缺少一手真实图文/视频凭证: 769 篇 (按硬门禁扣40分一票否决)",
      "引用过时淘汰陈旧基准: 0 篇 (扣20分)",
      "观点平庸/缺乏硬核架构与落地账本 (<95分): 701 篇"
    ],
